...
public class BeanUtil extends org.springframework.beans.BeanUtils {
     ...
     * @return
     */
    public static <T> List copyList(Object source, Class<T> clazz) {
        if (ObjectValidUtil.isInvalid(source)) {
            return new ArrayList();
        }
        return JsonUtil.parseArray(JsonUtil.toJson(source), clazz);
    }
     ...
     * @return
     */
    public static <T> Map<String, T> copyMap(Object source, Class<T> clazz) {
        return JsonUtil.toMap(JsonUtil.toJson(source), clazz);
    }
     ...
     * @return
     */
    public static <T> T copyJson(Object source, Class<T> clazz) {
        return JsonUtil.parse(JsonUtil.toJson(source), clazz);
    }
}
